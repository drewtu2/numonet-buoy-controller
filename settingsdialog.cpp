    ...
    ui(new Ui::SettingsDialog)
{
    ...
    fillPortsParameters();
    fillPortsInfo();
    ui->serialPortInfoListBox->setCurrentIndex(2); //Initalize with the 3rd item (after iphone and bluetooth). This setting will likely need to be adjusted as you change devices
    updateSettings();
}
